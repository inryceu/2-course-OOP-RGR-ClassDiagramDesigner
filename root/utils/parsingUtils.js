export function isRegexStart(code, index) {
    let i = index - 1;
...
export function skipRegex(code, index) {
    let i = index + 1;
...
export function removeComments(code, options = {}) {
    let result = '';
    let i = 0;
    let inString = false;
    let stringChar = '';
...
export function extractBalancedBraces(code, startIndex, options = {}) {
    let braceCount = 1;
    let i = startIndex;
    let inString = false;
    let stringChar = '';
...
export function getTopLevelStatements(content, options = {}) {
    const statements = [];
    let current = '';
    let i = 0;
    let depth = 0;
...
export function skipBlock(content, startIndex) {
    let depth = 0;
    let i = startIndex;
    while (i < content.length) {
        if (content[i] === '{')
