...
import { parseCppParameters, splitFieldDeclarations, parseFieldDeclaration } from '../utils/parserHelpers.js';
...
export class CppParser extends BaseParser {
    ...
    parseFields(content, classInfo, visibility) {
    ...
    parseMethods(content, classInfo, visibility) {
        const statements = getTopLevelStatements(content);
    ...
    parseInheritance(className, inheritanceStr, diagram) {
        ...
        for (const baseClass of baseClasses) {
            ...
            if (fullMatch) {
                ...
                diagram.addRelationship(new Relationship(className, baseClassName, RelationType.INHERITANCE));
            }
        }
    }
}
